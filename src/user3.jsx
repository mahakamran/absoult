...
const User = () => {
  return (
   < div className='flex lg:flex-row  flex-col lg:flex justify-center mt-[40px]'>
      {/* Sidebar */}
      <div className='lg:h-[660px] lg:w-[280px] h-[450px]  w-[350px] ml-4 bg-gradient-to-t from-orange-500 to-pink-600 lg:rounded-tl-[10px] lg:rounded-bl-[10px] rounded-2xl'>
  ...
  <h5 className="text-lg">User</h5>
      ...
      {/* Main Content */}
      <div className='lg:w-[1100px]  lg:flex-row flex-col lg:h-[660px] bg-white w-[350px] ml-4   mt-5  rounded-2xl lg:rounded-tr-[10px] lg:rounded-br-[10px]'>
    ...
    <div className='lg:w-[370px] lg:h-[590px]  lg:border-5   border-gray-200 rounded-4xl    lg:mt-[-550px] lg:ml-[390px] '>
     ...
     <NavLink to='/user4'>
     <div className='w-[300px] h-[550px] lg:mt-[-540px]  ml-8 mt-7 lg:ml-[780px]'>
