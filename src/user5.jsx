...
const User = () => {
  return (
    < div className='flex lg:flex-row  flex-col lg:flex justify-center mt-[40px]'>
       {/* Sidebar */}
       <div className='lg:h-[660px] lg:w-[280px]  w-[320px] h-[350px] ml-2 bg-gradient-to-t from-orange-500 to-pink-600 lg:rounded-tl-[10px] lg:rounded-bl-[10px] rounded-2xl'>
 ...
 <div className='lg:w-[310px] lg:h-[280px] bg-white  w-[300px] h-[280px] ml-2  mt-11 lg:mt-[-550px] lg:ml-[770px] border-5 border-gray-200 rounded-4xl'>
      ...
      <h3 className='text-xl pl-5 text-gray-800 underline mt-[-50px] ml-24 underline-offset-9 decoration-orange-600 decoration-2'>
        ...
        < FaPhone  className="transform scale-x-[-1] mt-1  text-orange-600"/>
         <p className='text-gray-600'>009-766-656</p>
        </div>
        <div className='flex justify-evenly mt-5'>
        < FaEnvelope  className="transform scale-x-[-1] mt-1  text-orange-600"/>
         <p className='text-gray-600'>123@gmail.com</p>
        </div>
        <div className='flex justify-evenly mt-5'>
        < FaMapMarkerAlt  className="transform scale-x-[-1] mt-1  text-orange-600"/>
         <p className='text-gray-600'>ABS-block-karachi</p>
        </div>
      
    </div>
    <div className='lg:w-[310px] lg:h-[260px] lg:mt-4  mt-6 bg-white w-[300px] h-[280px] ml-2   lg:ml-[770px] border-5 border-gray-200 rounded-4xl'>
    <h3 className='text-xl pl-5 pt-5 text-gray-800 underline underline-offset-9 decoration-orange-600 decoration-2'>
         New Meassages
        </h3>
      <img src={img3} className='w-[40px] h-[40px] object-cover rounded-full mt-7 ml-5' alt="" />
      <h4 className='font-semibold mt-[-30px] text-gray-600 pl-24'>Carry Troff</h4>
   <div className='bg-gray-200 w-[28px] h-[25px] ml-[250px] rounded-full '>
   <FaEnvelope className='mt-[-18px] ml-[4px] pt-1 text-xl text-orange-600'/>
   </div>
   <img src={img} className='w-[40px] h-[40px] object-cover rounded-full mt-4 ml-5' alt="" />
      <h4 className='font-semibold mt-[-30px] text-gray-600 pl-24'>Carry Troff</h4>
   <div className='bg-gray-200 w-[28px] h-[25px] ml-[250px] rounded-full '>
   <FaEnvelope className='mt-[-18px] ml-[4px] pt-1 text-xl text-orange-600'/>
   </div>
   <img src={img1} className='w-[40px] h-[40px] object-cover rounded-full mt-5 ml-5' alt="" />
      <h4 className='font-semibold mt-[-30px] text-gray-600 pl-24'>Carry Troff</h4>
   <div className='bg-gray-200 w-[28px] h-[25px] ml-[250px] rounded-full '>
   <FaEnvelope className='mt-[-18px] ml-[4px] pt-1 text-xl text-orange-600'/>
   </div>
