...
const Manage = () => {
  return (
   < div className='flex lg:flex-row  flex-col lg:flex justify-center mt-[40px]'>
           {/* Sidebar */}
               <div className='lg:h-[660px] lg:w-[280px]   h-[500px] w-[360px]  ml-7 bg-gradient-to-t from-orange-500 to-pink-600 lg:rounded-tl-[10px] lg:rounded-bl-[10px] rounded-2xl'>
  ...
  <h5 className="text-lg">User</h5>
           ...
           {/* Main Content */}
           <div className='lg:w-[1080px] lg:h-[620px] bg-white lg:rounded-tr-[10px] lg:rounded-br-[10px] w-[360px] ml-7 rounded-[5px] mt-7'>
        ...
        <div className='lg:w-[800px] lg:h-[470px] bg-rose-200   rounded-xl mt-5  w-[340px] ml-3 lg:ml-11'>
         <div className='flex '>
   ...
   <div className='flex lg:gap-1   gap-3 ml-[-190px] mt-[180px] lg:ml-14'>
    ...
    <div  className='lg:w-[130px] lg:h-[35px] w-20 h-8 rounded-[14px]  lg:ml-0 ml-[-5px] lg:rounded-2xl bg-white text-center pt-1'>Update</div>
         ...
         <div className='lg:flex gap-3 lg:ml-40'>
            <div className='lg:w-[270px]  w-[280px] ml-7  h-10  mt-5 lg:h-[43px] rounded bg-white pl-3 pt-2'>First name</div>
            <div className='lg:w-[270px]  h-10 mt-3 w-[280px] ml-7 lg:h-[43px] rounded bg-white pl-3 pt-2'>Last name</div>

  
            
        </div>
        <div className='lg:flex gap-3 lg:ml-40'>
            <div className='lg:w-[270px]  w-[280px] ml-7  h-10  mt-5 lg:h-[43px] rounded bg-white pl-3 pt-2'>Phone Number</div>
            <div className='lg:w-[270px]  h-10 mt-3 w-[280px] ml-7 lg:h-[43px] rounded bg-white pl-3 pt-2'>Email</div>

  
            
        </div>
        <div className='lg:flex gap-3 lg:ml-40'>
            <div className='lg:w-[270px]  w-[280px] ml-7  h-10  mt-5 lg:h-[43px] rounded bg-white pl-3 pt-2'>Address</div>
            <div className='lg:w-[270px]  h-10 mt-3 w-[280px] ml-7 lg:h-[43px] rounded bg-white pl-3 pt-2'>Contact</div>

  
            
        </div>
        <div className='lg:flex gap-3 lg:ml-40'>
            <div className='lg:w-[270px]  w-[280px] ml-7  h-10  mt-5 lg:h-[43px] rounded bg-white pl-3 pt-2'>Username</div>
            <div className='lg:w-[270px]  h-10 mt-3 w-[280px] ml-7 lg:h-[43px] rounded bg-white pl-3 pt-2'>Password</div>

  
            
        </div>
        <button className='bg-gradient-to-t from-orange-500 to-red-600 lg:w-[100px] w-[280px] h-[35px] lg:ml-40  mt-4  ml-7 lg:mt-7 text-white text-xl rounded'>Save</button>
        </div>
