...
const Manage = () => {
  return (
   < div className='flex lg:flex-row  flex-col lg:flex justify-center mt-[40px]'>
           {/* Sidebar */}
               <div className='lg:h-[660px] lg:w-[280px]   h-[500px] w-[380px]  ml-3 bg-gradient-to-t from-orange-500 to-pink-600 lg:rounded-tl-[10px] lg:rounded-bl-[10px] rounded-2xl'>
  ...
  <h5 className="text-lg">User</h5>
           ...
           {/* Main Content */}
           <div className='lg:w-[1080px] lg:h-[620px] bg-white lg:rounded-tr-[10px] lg:rounded-br-[10px] w-[380px] ml-3 rounded-[5px] mt-7'>
        ...
        <div className='lg:w-[800px] lg:h-[470px] bg-rose-200   rounded-xl mt-5  w-[350px] ml-3 lg:ml-11'>
         <div className='flex '>
